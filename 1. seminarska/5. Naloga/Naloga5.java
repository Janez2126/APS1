...
class Slika{
    ...
    void gor(){
        ...
        if(Naloga5.vseCrke.indexOf(trenutno[lokacijaVozicka][trenutno[lokacijaVozicka].length-1])==-1){
            ...
            System.arraycopy(trenutno[lokacijaVozicka], 0, trenutno[lokacijaVozicka], 1, trenutno[lokacijaVozicka].length-1);
            trenutno[lokacijaVozicka][0]=0;
        }else{
            flag=false;
        }
    ...
    void dol(){
        if(Naloga5.vseCrke.indexOf(trenutno[lokacijaVozicka][0])==-1){
            System.arraycopy(trenutno[lokacijaVozicka], 1, trenutno[lokacijaVozicka], 0, trenutno[lokacijaVozicka].length-1);
            trenutno[lokacijaVozicka][trenutno[lokacijaVozicka].length-1]=0;
        }else{
            flag=false;
        }
...
public class Naloga5 {
    ...
    public static void main(String[] args) throws IOException{
        ...
        char[][]orig=new char[stTrakov][dolzina];
        vseCrke="";
        koncna=new char[stTrakov][dolzina];
        for(int i = 0;i<stTrakov;i++){
            ...
            try{
                ...
                if(vrstica[1].charAt(j)==','){
                    ...
                    orig[i][stevec]=vrstica[1].charAt(j);
                    j++;
                    stevec++;
                }
                }
        ...
        for(int i = 0;i<stTrakov;i++){
            ...
            try{
                ...
                if(vrstica[1].charAt(j)==','){
                    ...
                    koncna[i][stevec]=vrstica[1].charAt(j);
                    j++;
                    stevec++;
                }
                }
        ...
        //System.out.println(Arrays.deepEquals(orig, orig));
        MapOfHashes hashes = new MapOfHashes(5500000);
        Queue queue= new Queue();
        queue.makenull();
		
		Slika s = new Slika(orig, "", 0,(char)0,7);

        if (s.primerjaj(koncna)) {
		...
		while (!queue.empty())
		{
			...
			queue.dequeue();
            //System.out.println(Arrays.deepToString(tmp.trenutno));
           // System.out.println(tmp.navodila);
            //System.out.println("bu");
            if (tmp.primerjaj(koncna)) {
        ...
        /* 
        Slika tmp = new Slika(orig, "", 0,(char)0,7);
        ...
        System.out.println("-------------------------------------------------------------");
		*/
        //System.out.println(Arrays.deepToString(koncna));
